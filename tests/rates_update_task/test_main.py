...
async def test_main_happy_path(fixture_filled_rates: SummaryRates, mocker):
    mocker.patch('app.rates_update_task.get_forex_rates', return_value=fixture_filled_rates.forex)
    mocker.patch('app.rates_update_task.get_cash_rates', return_value=fixture_filled_rates.cash)
